...
<div class="container bg-light d-md-flex align-items-center">
  ...
  <div class="card box1 shadow-sm p-md-5 p-4">
    ...
    <div class="d-flex flex-column">
      ...
      <div class="d-flex flex-column mb-4">
        ...
        <span class="ps-3" id="invoice-id"></span>
      </div>
      <div class="d-flex flex-column mb-5">
        <span class="far fa-calendar-alt text">
          <span class="ps-2">Next payment:</span>
        </span>
        <span class="ps-3" id="next-payment-date"></span>
      </div>
  ...
  <div class="card box2 shadow-sm">
    <div class="d-flex align-items-center justify-content-between p-md-5 p-4">
      <span class="h5 fw-bold m-0">Rsm Payment Gateway</span>
    ...
    <ul class="nav nav-tabs mb-3 px-md-4 px-2">
      ...
      <li class="nav-item">
        <a class="nav-link px-2" href="#">Bank Payment</a>
      </li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex flex-column px-md-5 px-4 mb-4">
            ...
            <div class="inputWithIcon">
              <input class="form-control" type="text" id="credit-card-number" placeholder="Enter credit card number">
              <span class="">
        ...
        <div class="col-12">
          <div class="d-flex flex-column px-md-5 px-4 mb-4">
            <span>Name</span>
            <div class="inputWithIcon">
              <input class="form-control text-uppercase" type="text" id="card-holder-name" placeholder="Enter cardholder name">
              <span class="far fa-user"></span>
            </div>
          </div>
        </div>
        <div class="col-12 px-md-5 px-4 mt-3">
          <button type="submit" class="btn btn-primary w-100" id="pay-button">Pay</button>
        </div>
      </div>
    </form>
    ...
    <div id="mobile-payment" style="display: none;">
      <div class="px-md-5 px-4 mb-4">
        <h5>Pay with TIGOlipa</h5>
        <p>Number: 787678</p>
        <button class="btn btn-primary" id="pay-tigolipa">Pay with TIGOlipa</button>
      </div>
    </div>
    ...
    <div id="bank-payment" style="display: none;">
      <div class="px-md-5 px-4 mb-4">
        <h5>Pay by Bank</h5>
        <p>Account Number: 7848484848489</p>
        <button class="btn btn-primary" id="pay-bank">Pay by Bank</button>
      </div>
    </div>
  </div>
</div>
<footer class="text-center mt-4">
  <p>Copyright &copy; 2024 | Crown & Roman Cooperation</p>
</footer>
</body>
</html>