...
<table class="table table-bordered">
    ...
    <tbody>
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $currentCart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <!--[if BLOCK]><![endif]--><?php if($item->options['shelf_product_id']): ?>
                        Shelf
                    <?php else: ?>
                        <?php
                            ...
                            $productLocation = \App\Models\ProductLocation::where('product_id', $item->id)
                                ...
                                ->first();
                        ?>
                        <?php echo e($productLocation ? optional($productLocation->location)->name : 'N/A'); ?>

                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </td>
                <td><?php echo e(number_format($item->price, 2)); ?></td>
                <td>
                    <input type="number" wire:model.debounce.500ms="cartDiscounts.<?php echo e($item->rowId); ?>" 
                           min="0" step="0.01" class="form-control w-75" 
                           wire:change="updateDiscount('<?php echo e($item->rowId); ?>', $event.target.value)">
                </td>
                <td>
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="4" class="text-end">Tax (<?php echo e($taxRate); ?>%)</td>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="addCustomProduct">
                    <div class="mb-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['customProductName'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mb-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['customProductQuantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mb-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['customProductPrice'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mb-3">
                        ...
                        <select wire:model="customLocationId" class="form-select" id="customLocationId" required>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = \App\Models\Location::where('account_id', auth()->user()->account_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($location->id); ?>"><?php echo e($location->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </select>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['customLocationId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger"><?php echo e($message); ?></span> <?php unset($message);
