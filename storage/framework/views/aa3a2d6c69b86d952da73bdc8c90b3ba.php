...
<div class="col-sm-6 col-md-6">
    <div class="mb-3">
        ...
        <input class="form-control" name="quantity" type="text" readonly value="<?php echo e(old('quantity', $product->quantity)); ?>" style="color: var(--tblr-secondary); background-color: var(--tblr-bg-surface-secondary); opacity: 1;">
    </div>
</div>
<div class="col-sm-6 col-md-6">
    <div class="mb-3">
        ...
        <div id="locationFields">
            <?php $__currentLoopData = $product->productLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row mb-2 align-items-end location-row">
                    <div class="col-md-6">
                        <select name="location_ids[]" class="form-select" required>
                            <?php $__currentLoopData = \App\Models\Location::where('account_id', auth()->user()->account_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($loc->id); ?>" <?php echo e($location->location_id == $loc->id ? 'selected' : ''); ?>><?php echo e($loc->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-5">
                        <input type="number" name="quantities[]" value="<?php echo e($location->quantity); ?>" class="form-control" min="0" required>
                    </div>
                    <div class="col-md-1" <?php if($index == 0): ?> style="display: none;" <?php endif; ?>>
...
<?php if (! $__env->hasRenderedOnce('e2d13290-e90b-47e4-bb57-ff4a9d95b195')): $__env->markAsRenderedOnce('e2d13290-e90b-47e4-bb57-ff4a9d95b195');
