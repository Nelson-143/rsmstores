...
<div class="email-container">
        <div class="email-header">
            <div class="logo-container">
                <img src="<?php echo e(asset('static/logo2.png')); ?>" style="width: 200px; height: auto;" alt="Roman Stock Manager" class="navbar-brand-image">
            </div>
        </div>
        <div class="email-body">
            ...
            <a href="<?php echo e($verificationUrl); ?>" class="btn">Activate Your Account</a>
        ...
        <div class="email-footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> Roman Stock Manager. All rights reserved.</p>
...
<?php echo $__env->make('layouts.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\rstoresV1R\rsmstores\resources\views/emails/verify-email.blade.php ENDPATH**/ ?>