...
<div class="col-sm-6 col-lg-3">
    ...
    <div class="ms-auto lh-1">
        <select name="period" class="form-select" onchange="this.form.submit()">
            ...
            <div class="d-flex align-items-baseline">
                <div class="h1 mb-3 me-2"> <?php echo e(auth()->user()->account->currency); ?> <?php echo e(isset($carts) ? number_format($carts, 2) : '0.00'); ?></div>
                <div class="me-auto">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><?php echo e(__('Business Growth Rate')); ?></h3>
            </div>
            <div class="card-body">
...
<script>
  ...
  const growthData = {
        labels: <?php echo json_encode($months); ?>, // Months (e.g., ["Jan 2023", "Feb 2023", ...])
        datasets: [{
            label: 'Sales Growth Rate (%)',
            data: <?php echo json_encode($growthRate); ?>, // Growth rates (e.g., [12.34, -5.67, ...])
