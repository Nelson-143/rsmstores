...
<small class="text-muted"><?php echo e(__('Today is')); ?> ,<?php echo e(date('l, F j, Y')); ?></small>
...
<div class="subheader"><?php echo e(__('Total Customers')); ?></div>
<div class="ms-auto lh-1">
<div class="dropdown">
<a class="text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('Total Customers')); ?></a>
...
<div class="h1 mb-3"><?php echo e(isset($customers) ? number_format($customers) : '0'); ?>
...
<div class="card-body">
<div class="d-flex align-items-center">
<div class="subheader"><?php echo e(__('Total Debt')); ?></div>
<div class="ms-auto lh-1">
<div class="dropdown">
<a class="text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('Total Debts')); ?></a>
<div class="dropdown-menu dropdown-menu-end">
...
<div class="h1 mb-0 me-2">
    <?php echo e(auth()->user()->account->currency); ?> <?php echo e(isset($debt) ? number_format($debt, 2) : '0.00'); ?>
...
<div class="card-body">
<div class="d-flex align-items-center">
<div class="subheader"><?php echo e(__('Total Branches')); ?></div>
<div class="ms-auto lh-1">
<div class="dropdown">
<a class="text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('Your Branches')); ?></a>
<div class="dropdown-menu dropdown-menu-end">
...
<div class="d-flex align-items-baseline">
        <div class="h1 mb-3 me-2"><?php echo e(isset($branch) ? number_format($branch) : '1'); ?></div>
        <div class="me-auto">
...
<div class="col-sm-6 col-lg-3">
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="subheader"><?php echo e(__('Total Sales')); ?></div>
                <div class="ms-auto lh-1">
                    <?php if(request('period') == 'daily' || !request('period')): ?>
                    <form method="GET" action="<?php echo e(route('dashboard')); ?>" id="date-select-form" class="d-flex align-items-center">
                        ...
                        <div class="input-icon">
                            ...
                            <input class="form-control form-control-sm" placeholder="Select date" id="selected_date" name="selected_date" value="<?php echo e($selectedDate ?? now()->format('Y-m-d')); ?>" type="date" onchange="this.form.submit()">
                        </div>
                    </form>
                    <?php else: ?>
                    <form method="GET" action="<?php echo e(route('dashboard')); ?>" class="d-flex align-items-center">
                        <div class="ms-auto lh-1">
                            <select name="period" class="form-select form-select-sm" onchange="this.form.submit()">
                                <option value="daily" <?php echo e(request('period') == 'daily' ? 'selected' : ''); ?>><?php echo e(__('Daily Sales')); ?></option>
                                <option value="weekly" <?php echo e(request('period') == 'weekly' ? 'selected' : ''); ?>><?php echo e(__('Weekly Sales')); ?></option>
                                <option value="monthly" <?php echo e(request('period') == 'monthly' ? 'selected' : ''); ?>><?php echo e(__('Monthly Sales')); ?></option>
                                <option value="yearly" <?php echo e(request('period') == 'yearly' ? 'selected' : ''); ?>><?php echo e(__('Yearly Sales')); ?></option>
                            </select>
                        </div>
                    </form>
                    <?php endif; ?>
            ...
            <div class="d-flex align-items-baseline">
                <div class="h1 mb-0 me-2">
                    <?php if(isset($isFutureDate) && $isFutureDate): ?>
                        <div class="text-warning"><?php echo e($dailySalesMessage); ?></div>
                    <?php elseif(isset($hasNoSales) && $hasNoSales): ?>
                        <div class="text-muted"><?php echo e($dailySalesMessage); ?></div>
                    <?php else: ?>
                        <?php echo e(auth()->user()->account->currency); ?> <?php echo e(isset($carts) ? number_format($carts, 2) : '0.00'); ?>
                ...
                <div class="mt-2">
                    <small class="text-muted">
                        <?php if(isset($selectedDate)): ?>
                            Sales for: <?php echo e(\Carbon\Carbon::parse($selectedDate)->format('M d, Y')); ?>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                <?php echo e($products); ?> <?php echo e(__('Products')); ?>

                                            </div>
                                            <div class="text-muted">
                                                <?php echo e($categories); ?> <?php echo e(__('categories')); ?>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                <?php echo e($orders); ?> <?php echo e(__('Orders')); ?>

                                            </div>
                                            <div class="text-muted">
                                                <?php echo e($todayOrders); ?> <?php echo e(__('shipped')); ?>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                <?php echo e($purchases); ?> <?php echo e(__('Purchases')); ?>

                                            </div>
                                            <div class="text-muted">
                                                <?php echo e($todayPurchases); ?> <?php echo e(__('today')); ?>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                <?php echo e($quotations); ?> <?php echo e(__('Quotations')); ?>

                                            </div>
                                            <div class="text-muted">
                                                <?php echo e($todayQuotations); ?> <?php echo e(__('today')); ?>
...
<div class="col-md-6">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><?php echo e(__('Daily Business Growth Rate')); ?></h3>
        </div>
        <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><?php echo e(__('Out of Stock Products')); ?>
...
<script>
  ...
  const growthData = {
    labels: <?php echo json_encode($days); ?>, // Last 14 days (e.g., ["May 01", "May 02", ...])
    datasets: [
      {
        label: 'Daily Sales (<?php echo e(auth()->user()->account->currency); ?>)',
        data: <?php echo json_encode($salesValues); ?>, // Daily sales values
      ...
      {
        label: 'Growth Rate (%)',
        data: <?php echo json_encode($dailyGrowthRates); ?>, // Daily growth rates
    ...
    options: {
            ...
            label: function(context) {
              ...
              if (context.datasetIndex === 0) {
                label += new Intl.NumberFormat('en-US', { 
                  style: 'currency',
                  currency: '<?php echo e(auth()->user()->account->currency); ?>' 
      ...
      scales: {
        y: {
          ...
          title: {
            display: true,
            text: 'Sales Amount (<?php echo e(auth()->user()->account->currency); ?>)'
          },
          beginAtZero: true
        },
        y1: {
...
<?php echo $__env->make('layouts.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\rstoresV1R\rsmstores\resources\views/dashboard.blade.php ENDPATH**/ ?>