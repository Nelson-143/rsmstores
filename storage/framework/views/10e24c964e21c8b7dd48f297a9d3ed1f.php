                ...
                <div class="stg-row stg-large-gap stg-tp-normal-gap stg-tp-column-reverse">
                    <div class="stg-col-6 stg-vertical-space-between" data-unload="fade-left">
                        ...
                        <div class="align-right" data-appear="fade-right">
                            <a href="<?php echo e(route('price.route')); ?>" class="bringer-icon-link">
                    ...
                    <div class="stg-col-6 stg-tp-bottom-gap-l" data-appear="fade-left" data-unload="fade-right">
                        <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/bgg.jpg')); ?>" alt="Brainding" width="800" height="1200">
                    </div>
                </div>
            </section>
            ...
            <section class="backlight-both">
                ...
                <div class="stg-row stg-bottom-gap stg-valign-middle stg-m-bottom-gap-l" data-unload="fade-left">
                    <div class="stg-col-3 stg-offset-3 stg-tp-col-6 stg-m-bottom-gap" data-appear="fade-right">
                        <div class="bringer-parallax-media">
                            <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/inv.jpg')); ?>" alt="Branding 01" width="960" height="960">
                        </div>
                    </div>
                ...
                <div class="stg-row stg-bottom-gap stg-valign-middle stg-tp-row-reverse stg-m-bottom-gap-l" data-unload="fade-right">
                    <div class="stg-col-3 stg-tp-col-6 stg-m-bottom-gap" data-appear="fade-left">
                        <div class="bringer-parallax-media">
                            <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/mee.jpg')); ?>" alt="Branding 02" width="960" height="960">
                        </div>
                    </div>
                ...
                <div class="stg-row stg-bottom-gap stg-valign-middle stg-m-bottom-gap-l" data-unload="fade-left">
                    <div class="stg-col-3 stg-offset-3 stg-tp-col-6 stg-m-bottom-gap" data-appear="fade-right">
                        <div class="bringer-parallax-media">
                            <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/dep.jpg')); ?>" alt="Branding 03" width="960" height="960">
                        </div>
                    </div>
                    <div class="stg-col-6 stg-tp-col-6" data-appear="fade-right" data-delay="100">
                ...
                <div class="stg-row stg-bottom-gap stg-valign-middle stg-tp-row-reverse stg-m-bottom-gap-l" data-unload="fade-right">
                    <div class="stg-col-3 stg-tp-col-6 stg-m-bottom-gap" data-appear="fade-left">
                        <div class="bringer-parallax-media">
                            <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/hall.jpg')); ?>" alt="Branding 04" width="960" height="960">
                        </div>
                    </div>
                    <div class="stg-col-6 stg-tp-col-6" data-appear="fade-left" data-delay="100">
                ...
                <div class="stg-row stg-valign-middle" data-unload="fade-left">
                    <div class="stg-col-3 stg-offset-3 stg-tp-col-6 stg-m-bottom-gap" data-appear="fade-right">
                        <div class="bringer-parallax-media">
                            <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/web.jpg')); ?>" alt="Branding 05" width="960" height="960">
                        </div>
                    </div>
                    <div class="stg-col-6 stg-tp-col-6" data-appear="fade-right" data-delay="100">
            ...
            <section>
                ...
                <div class="bringer-grid-3cols bringer-tp-grid-2cols bringer-tp-stretch-last-item" data-stagger-appear="fade-up" data-stagger-unload="fade-up">
                    ...
                    <div class="bringer-masked-block bringer-grid-more-masked">
                        ...
                        <a href="<?php echo e(route('contact.route')); ?>"></a>
                    </div>
                </div>
            </section>
...
<?php echo $__env->make('front.themefront', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\rstoresV1R\rsmstores\resources\views/front/service.blade.php ENDPATH**/ ?>