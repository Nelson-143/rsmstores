        ...
        <div class="stg-container">
            ...
            <section class="backlight-bottom">
                ...
                <div class="bringer-parallax-media" data-parallax-speed="20" data-appear="fade-up" data-delay="200" data-unload="fade-up">
                    <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/ref.jpg')); ?>" alt="Get in Touch" width="1920" height="960">
            ...
            <section>
                ...
                <div class="bringer-grid-3cols bringer-parallax-media bringer-m-grid-3cols stg-m-small-gap" data-stagger-appear="fade-up" data-delay="200" data-stagger-unload="fade-up">
                    <a href="<?php echo e(asset('frontend/assets/img/inner-pages/spp.jpg')); ?>" class="bringer-lightbox-link" data-size="960x960">
                        <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/spp.jpg')); ?>" alt="Bringer" width="960" height="960">
                    </a>
                    <a href="<?php echo e(asset('frontend/assets/img/inner-pages/qnn.jpg')); ?>" class="bringer-lightbox-link" data-size="960x960">
                        <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/qnn.jpg')); ?>" alt="Bringer" width="960" height="960">
                    </a>
                    <a href="<?php echo e(asset('frontend/assets/img/inner-pages/rt.jpg')); ?>" class="bringer-lightbox-link" data-size="960x960">
                        <img class="bringer-lazy" src="<?php echo e(asset('frontend/assets/img/null.png')); ?>" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/rt.jpg')); ?>" alt="Bringer" width="960" height="960">
                    </a>
                </div>
            </section>
            ...
            <section class="backlight-top is-fullwidth">
                <div class="stg-row stg-valign-middle stg-cta-with-image stg-tp-column-reverse">
                    <div class="stg-col-5" data-unload="fade-left">
                        <div class="bringer-offset-image" data-bg-src="<?php echo e(asset('frontend/assets/img/curr.jpg')); ?>" data-appear="fade-up" data-threshold="0.25"></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.themefront', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\rstoresV1R\rsmstores\resources\views/front/contact.blade.php ENDPATH**/ ?>