<?php
 ...
 ?>
  ...
  <script>
    ...
    let $pageLength = <?php echo json_encode($crud->getPageLengthMenu(), 15, 512) ?>;
    
    let $dtStoredPageLength = parseInt(localStorage.getItem('DataTables_crudTable_/<?php echo e($crud->getRoute()); ?>_pageLength'));
      ...
      dataTableConfiguration: {
        ...
        */
        ...
        language: {
          ...
          processing: true,
          serverSide: true,
          searchDelay: <?php echo e($crud->getOperationSetting('searchDelay')); ?>,
...
<?php /**PATH C:\rstoresV1R\rsmstores\resources\views/vendor/backpack/crud/inc/datatables_logic.blade.php ENDPATH**/ ?>