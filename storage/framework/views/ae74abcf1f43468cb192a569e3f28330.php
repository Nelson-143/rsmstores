...
<div class="stg-container">
                    ...
                    <div class="swiper bringer-slider bringer-masked-media" data-autoplay="2000" data-duration="800" data-effect="slide">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('frontend/assets/img/inner-pages/view4.jpg')); ?>" alt="Positive Beverage" width="1920" height="1080">
                            </div>
                            <!-- Slider Item -->
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('frontend/assets/img/inner-pages/view5.jpeg')); ?>" alt="Positive Beverage" width="1920" height="1080">
                            </div>
                            <!-- Slider Item -->
                            <div class="swiper-slide">
                                <img src="<?php echo e(asset('frontend/assets/img/inner-pages/view6.jpeg')); ?>" alt="Positive Beverage" width="1920" height="1080">
                            </div>
                             <!-- Slider Item -->
                             <div class="swiper-slide">
                                <img src="<?php echo e(asset('frontend/assets/img/inner-pages/view8.jpg')); ?>" alt="Positive Beverage" width="1920" height="1080">
                            </div>
                        </div>
                    </div><!-- .bringer-slider -->
                    <!-- Masked Navigation -->
            ...
            <section data-tp-padding="none">
                <div class="bringer-grid-3cols" data-stagger-appear="fade-up" data-stagger-unload="fade-left">
                    <div>
                        <img class="bringer-lazy" src="img/null.png" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/pos09.jpg')); ?>" alt="Positive Beverage" data-speed="0.9" data-m-speed="1" width="800" height="1200">
                    </div>
                    <div>
                        <img class="bringer-lazy" src="img/null.png" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/pos02.jpg')); ?>" alt="Positive Beverage" width="800" height="1200">
                    </div>
                    <div>
                        <img class="bringer-lazy" src="img/null.png" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/pos08.jpg')); ?>" alt="Positive Beverage" data-speed="1.1" data-m-speed="1" width="800" height="1200">
                    </div>
                </div>
            </section>
            ...
            <section data-padding="none" data-unload="zoom-out">
                <div class="bringer-expand-on-scroll">
                    <img class="bringer-lazy" src="img/null.png" data-src="<?php echo e(asset('frontend/assets/img/inner-pages/view2.png')); ?>" alt="Positive Beverage" width="1920" height="960">
            ...
            <section class="divider-top" data-appear="fade-up">
                <div class="align-center" data-unload="zoom-in">
                    <a href="<?php echo e(route('contact.route')); ?>" class="bringer-icon-link bringer-next-post">
...
<?php echo $__env->make('front.themefront', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\rstoresV1R\rsmstores\resources\views/front/habout.blade.php ENDPATH**/ ?>